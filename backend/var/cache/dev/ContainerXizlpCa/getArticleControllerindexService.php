...
class getArticleControllerindexService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->privates['.service_locator.LXH8CDw.App\\Controller\\ArticleController::index()'] = (new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
