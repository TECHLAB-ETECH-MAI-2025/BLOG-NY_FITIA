...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'receivedMessages' => [parent::class, 'receivedMessages', null, 16],
        "\0".parent::class."\0".'roles' => [parent::class, 'roles', null, 16],
        "\0".parent::class."\0".'sentMessages' => [parent::class, 'sentMessages', null, 16],
        "\0".parent::class."\0".'votes' => [parent::class, 'votes', null, 16],
        ...
        'receivedMessages' => [parent::class, 'receivedMessages', null, 16],
        'roles' => [parent::class, 'roles', null, 16],
        'sentMessages' => [parent::class, 'sentMessages', null, 16],
        'votes' => [parent::class, 'votes', null, 16],
    ];
