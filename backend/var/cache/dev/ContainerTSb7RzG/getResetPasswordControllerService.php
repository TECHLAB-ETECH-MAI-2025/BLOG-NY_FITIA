...
<<<<<<< HEAD:backend/var/cache/dev/ContainerXizlpCa/getResetPasswordControllerService.php
<<<<<<<< HEAD:backend/var/cache/dev/ContainerOjV1UrF/getResetPasswordControllerService.php
namespace ContainerOjV1UrF;
========
namespace ContainerXizlpCa;
>>>>>>>> 7c704d2aa (Final Pagination react cote Backend):backend/var/cache/dev/ContainerXizlpCa/getResetPasswordControllerService.php
=======
namespace ContainerTSb7RzG;
>>>>>>> 11fdd162a (Debut Notification):backend/var/cache/dev/ContainerTSb7RzG/getResetPasswordControllerService.php
...
class getResetPasswordControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.xIvXWup'] ?? $container->load('get_ServiceLocator_XIvXWupService'))->withContext('App\\Controller\\ResetPasswordController', $container));
