...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.rvwW9pW'] ?? $container->load('get_ServiceLocator_RvwW9pWService'))->withContext('App\\Controller\\SecurityController', $container));
