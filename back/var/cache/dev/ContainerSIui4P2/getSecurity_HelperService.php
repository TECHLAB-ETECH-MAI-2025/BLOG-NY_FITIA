...
class getSecurity_HelperService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.helper'] = new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Security\\UserCustomAuthenticator' => ['privates', 'App\\Security\\UserCustomAuthenticator', 'getUserCustomAuthenticatorService', true],
        ], [
            ...
            'security.authenticator.remember_me.login' => ['privates', 'security.authenticator.remember_me.login', 'getSecurity_Authenticator_RememberMe_LoginService', true],
        ], [
            'security.authenticator.json_login.login' => '?',
            'security.authenticator.remember_me.login' => '?',
        ])]);
    }
}
