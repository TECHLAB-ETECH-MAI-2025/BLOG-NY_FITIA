...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\ChainRequestMatcher([($container->privates['.security.request_matcher.T8BdVIN'] ??= new \Symfony\Component\HttpFoundation\RequestMatcher\PathRequestMatcher('^/login'))]), ['IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
