 ...
 */
final class Version20250529234548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO message (id, sender_id, receiver_id, content, created_at, is_read) SELECT id, sender_id, recipient_id, content, created_at, is_read FROM __temp__message
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO message (id, sender_id, recipient_id, content, created_at, is_read) SELECT id, sender_id, receiver_id, content, created_at, is_read FROM __temp__message
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE __temp__message
        SQL);
