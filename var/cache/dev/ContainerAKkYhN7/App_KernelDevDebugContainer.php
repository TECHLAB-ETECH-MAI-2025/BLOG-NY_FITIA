...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/ApiSubscriber.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventSubscriber\\ApiSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\ApiSubscriber'] ??= new \App\EventSubscriber\ApiSubscriber()), 'onKernelRequest'], 10);
    ...
    {
        $a = new \Symfony\Component\Mercure\Jwt\LcobucciFactory('keymercure', 'hmac.sha256', NULL, '');

        return $container->privates['mercure.hub.default.traceable'] = new \Symfony\Component\Mercure\Debug\TraceableHub(new \Symfony\Component\Mercure\Hub('http://localhost:3000/.well-known/mercure', new \Symfony\Component\Mercure\Jwt\FactoryTokenProvider($a, [], []), $a, NULL, ($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container))), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'mercure.default_hub' => 'http://localhost:3000/.well-known/mercure',
